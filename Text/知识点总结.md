...
### 30. 如果后台数据只有一个字母a，先将他删除，再添加一个字母a, 会命中浏览器缓存吗？
...
POST GET OPTION HEAD DELETE PUT UPDATE
...
以下摘自：[博客园](https://www.cnblogs.com/AlbertP/p/10847627.html)
